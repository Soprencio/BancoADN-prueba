...
public class BancoADN6RequestHandler implements Runnable {
    ...
    static List<String[]> buscarMultiplesPorCampo(String nombreArchivo, int indice, String valor) throws Exception { 
        ...
        for (String reg : leerRegistros(nombreArchivo)) {
            String[] p = reg.split(" - ");
            if (p.length > indice && p[indice].toLowerCase().contains(valor.toLowerCase())) {
                resultados.add(p); 
            }
        }
        return resultados; 
    ...
    int iniciarSesion(String mail, String psw) throws Exception {
        ...
        for (String reg : leerRegistros("CuentaPersonal.txt")) {
            ...
            if (p[2].equalsIgnoreCase(mail) && Integer.valueOf(p[3])==psw.hashCode()) {
    ...
    String crearCuenta(String nombreArchivo, String[] Partes) throws Exception {
        ...
        if (Repetido == false){
            ...
            agregarRegistro("CuentaPersonal.txt",Partes[2] + " - " + Partes[1] + " - " + Partes[3].hashCode() + " - 1");
...
//        agregarRegistro("Logs.txt", "9 - " + obtenerIdCuenta(mailusr.get()) + " - " + date + " - " + obtenerNombre() + " creo una solicitud de perfil");
        agregarRegistro("Logs.txt", "9 - " + obtenerIdCuenta(mailusr.get()) + " - " + date + " - " + obtenerNombre() + " creo una solicitud de registro con los datos: " + datosSolicitud);
        mutexModRegistro.release();
...
//        return Respuesta;
    ...
    List<String> verSolicitudes() throws Exception {
        ...
        agregarRegistro("Logs.txt", "11 - " + obtenerIdCuenta(mailusr.get()) + " - " + date + " - " + obtenerNombre() + " busco la lista de solicitudes");
...
//    }
    ...
    List<String> ObtenerLogsAdmin() throws Exception {
        ...
        agregarRegistro("Logs.txt", "13 - " + obtenerIdCuenta(mailusr.get()) + " - " + date + " - " + obtenerNombre() + " busco la lista de logs");
    ...
    public void run() {
        try (
            ...
            agregarRegistro("Logs.txt", "14 - " + "Cliente" + " - " + date + " - Se conecto un cliente al servidor");
            mutexModRegistro.release();
