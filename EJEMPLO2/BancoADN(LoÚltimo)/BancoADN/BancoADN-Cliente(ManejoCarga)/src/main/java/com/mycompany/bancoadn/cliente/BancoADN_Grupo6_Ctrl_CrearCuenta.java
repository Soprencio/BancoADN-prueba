...
public class BancoADN_Grupo6_Ctrl_CrearCuenta implements ActionListener {
    ...
    private void crearCuenta(String nombreCuenta, String email, String contraseña) {
        ...
        // Activar indicador de carga antes de enviar
        vista.mostrarCargando(true);
 
        new SwingWorker<String, Void>() {
            @Override
            protected String doInBackground() throws Exception {
                // Corre en hilo separado — acá ocurre la espera del servidor
                return clienteSocket.enviarYRecibir(mensaje);
            }
 
            @Override
            protected void done() {
                // Corre de vuelta en el hilo de UI cuando el servidor respondió
                try {
                    ...
                    // Siempre desactivar el indicador al terminar, pase lo que pase
