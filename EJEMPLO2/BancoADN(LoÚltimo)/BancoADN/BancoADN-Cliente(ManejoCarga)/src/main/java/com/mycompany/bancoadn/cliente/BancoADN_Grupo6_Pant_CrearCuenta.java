...
import java.awt.Cursor; //Manejar cargando del cliente
...
public class BancoADN_Grupo6_Pant_CrearCuenta extends javax.swing.JFrame {
     ...
     * Cuando cargando=true:
     *   - Deshabilita el botón para evitar doble envío
     *   - Cambia el cursor a reloj de espera
    ...
    public void mostrarCargando(boolean cargando) {
        ...
        btnOjo.setEnabled(!cargando);
        // JLabel ignora setEnabled para clicks, se controla con la bandera en el listener
        lblVolver.setEnabled(!cargando);
        setCursor(cargando ?
    ...
    public void agregarListenerVolver(ActionListener listener) {
        lblVolver.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                // Si está cargando no hace nada, bloquea la navegación
                if (cargando) return;
